...
export default function Dashboard() {
	return (
		<>
			...
			<Sidebar />
			<Container>
				{/* <div className="flex items-center justify-center w-full text-3xl text-cool-gray-500"> */}
						...
						<div className="px-0 mb-0 border-0 rounded-t">
							<div className="flex flex-wrap items-center px-4 py-2">
								...
								<div className="relative flex-1 flex-grow w-full max-w-full text-right">
									<button
										className="px-3 py-1 mb-1 mr-1 text-xs font-bold text-white uppercase transition-all duration-150 ease-linear rounded outline-none bg-primary-500 dark:bg-gray-100 active:bg-primary-600 dark:text-gray-800 dark:active:text-gray-700 focus:outline-none"
										type="button"
									>
										See all
									</button>
										...
										<div className="flex items-center flex-grow py-2 text-sm text-gray-600 border-b border-gray-100 dark:border-gray-400 dark:text-gray-100">
											<div className="flex items-center justify-between flex-grow">
												<div className="self-center">
													<a
														className="font-medium text-gray-800 outline-none hover:text-gray-900 dark:text-gray-50 dark:hover:text-gray-100"
														href="#0"
													>
														Nick Mark
													</a>{' '}
													mentioned{' '}
													<a
														className="font-medium text-gray-800 outline-none dark:text-gray-50 dark:hover:text-gray-100"
														href="#0"
													>
														Sara Smith
													</a>{' '}
												...
												<div className="flex-shrink-0 ml-2">
													<a
														className="flex items-center font-medium outline-none text-primary-500 hover:text-primary-600 dark:text-primary-400 dark:hover:text-primary-500"
														href="#0"
													>
														View
														<span>
									...
									<li className="flex px-4">
										...
										<div className="flex items-center flex-grow py-2 text-sm text-gray-600 border-gray-100 dark:text-gray-50">
											<div className="flex items-center justify-between flex-grow">
												...
												<div className="flex-shrink-0 ml-2">
													<a
														className="flex items-center font-medium text-primary-500 hover:text-primary-600 dark:text-primary-400 dark:hover:text-primary-500"
														href="#0"
													>
														View
														<span>
								...
								<nav aria-label="Table navigation">
									<ul className="inline-flex items-center">
										...
										<li>
											<button
												type="button"
												className="px-3 py-1 text-white transition-colors duration-150 border border-r-0 rounded-md bg-primary-600 border-primary-600 dark:text-gray-800 dark:bg-gray-100 dark:border-gray-100 focus:outline-none focus:shadow-outline-purple"
											>
												3
											</button>
										</li>
						...
						<form className="flex flex-col justify-center p-6">
							<div className="flex flex-col">
								...
								<input
									...
									className="px-3 py-3 mt-2 font-semibold text-gray-800 bg-white border border-gray-400 rounded-lg w-100 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-50 focus:border-primary-500 focus:outline-none"
								/>
							</div>
							...
							<button
								type="submit"
								className="px-6 py-3 mt-4 font-bold text-white transition duration-300 ease-in-out rounded-lg bg-primary-600 md:w-32 dark:bg-gray-100 dark:text-gray-800 hover:bg-primary-500 dark:hover:bg-gray-200"
							>
								Submit
							</button>
						</form>
